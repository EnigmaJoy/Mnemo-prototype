...
export default function Logo({ className = '' }: LogoProps) {
  return (
    <div className={`flex items-center gap-2.5 ${className}`}>
      ...
      >
        <defs>
          <linearGradient id="mGrad" x1="0" y1="0" x2="88" y2="0" gradientUnits="userSpaceOnUse">
      ...
      {/* Wordmark */}
      <span
        className="font-cormorant font-light text-mnemo-ink text-sm uppercase"
